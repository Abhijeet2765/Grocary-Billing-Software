...
class Bill_App:
    def __init__(self,root):
        ...
        m1_txt=Entry(F6,width=18,textvariable=self.cosamtic_price,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=0,column=1,pady=1)
        ...
        c1_txt=Entry(F6,width=18,textvariable=self.cosmatic_tax,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=0,column=3,pady=1)
    ...
    def total(self):
        ...
        self.cosamtic_price.set("Rs. "+str(self.total_cosmatic_price))     
        self.cosmatic_tax.set("Rs. "+str(round((self.total_cosmatic_price*0.05),2)))
        #=============================syntax of round
        #round((value),2)
        ...
        self.c_p=self.total_cosmatic_price
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phone.get()=="":
        ...
        elif self.cosamtic_price.get()=="Rs. 0.0" and self.grocery_price.get()=="Rs. 0.0" and self.cold_drink_price.get()=="Rs. 0.0":
            messagebox.showerror("Error","No Product Selected")     
        else:
            self.welcome_bill()
            #===============================Condition For Cosmatic Frame
            if self.soap.get()!=0:
            ...
            if self.spray.get()!=0:
                self.txtarea.insert(END,f"\n  HairSpray      {self.spray.get()}      {self.c_hs_p}")
